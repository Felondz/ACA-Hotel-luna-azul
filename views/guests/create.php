<?php
// views/guests/create.php
require_once __DIR__ . '/../layouts/header.php';
?>

<div class="glass-panel">
  <div class="panel-header">
    <h2><i class="fa-solid fa-user-plus header-icon"></i> Registrar Nuevo Huésped</h2>
  ...
  <div class="panel-body">
    ...
    <form action="index.php?controller=guests&action=create" method="POST" id="guest-form" class="form-grid-layout" onsubmit="return validateGuestForm()">
      ...
      <div class="form-actions-bar">
        ...
        <button type="submit" class="btn btn-primary">
          <i class="fa-solid fa-floppy-disk"></i> Guardar Huésped
        </button>
      </div>
